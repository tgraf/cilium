...
type TestDaemon struct {
	...
	OnSVCDelete                 func(feL3n4 types.L3n4AddrID) error
	OnSVCDeleteBySHA256Sum      func(feL3n4SHA256Sum string) error
	OnSVCGet                    func(feL3n4 types.L3n4AddrID) ([]types.L3n4Addr, error)
	OnSVCGetBySHA256Sum         func(feL3n4SHA256Sum string) ([]types.L3n4Addr, error)
...
func (d TestDaemon) SVCDelete(feL3n4 types.L3n4AddrID) error {
...
func (d TestDaemon) SVCGet(feL3n4 types.L3n4AddrID) ([]types.L3n4Addr, error) {
	if d.OnSVCGet != nil {
...
func (d TestDaemon) SVCGetBySHA256Sum(feL3n4SHA256Sum string) ([]types.L3n4Addr, error) {
