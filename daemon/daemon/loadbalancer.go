...
func (d *Daemon) SVCDelete(feL3n4 types.L3n4AddrID) error {
...
// SVCGet returns a DeepCopied frontend with the given types.L3n4AddrID.
func (d *Daemon) SVCGet(feL3n4 types.L3n4AddrID) ([]types.L3n4Addr, error) {
	feL3n4Uniq, err := feL3n4.SHA256Sum()
	if err != nil {
		return nil, err
	}
...
// SVCGetBySHA256Sum returns a DeepCopied frontend with the given SHA256Sum.
func (d *Daemon) SVCGetBySHA256Sum(feL3n4SHA256Sum string) ([]types.L3n4Addr, error) {
