...
// to the daemon.
func (cli Client) SVCDelete(fe types.L3n4AddrID) error {
...
func (cli Client) SVCGet(fe types.L3n4AddrID) ([]types.L3n4Addr, error) {
	feSHA256Sum, err := fe.SHA256Sum()
	if err != nil {
...
func (cli Client) SVCGetBySHA256Sum(feSHA256Sum string) ([]types.L3n4Addr, error) {
	...
	var bes []types.L3n4Addr
	if err := json.Unmarshal(serverResp.Body(), &bes); err != nil {
		return nil, err
	}
