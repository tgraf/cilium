...
type lbBackend interface {
	...
	SVCDelete(feL3n4 types.L3n4AddrID) error
	SVCDeleteBySHA256Sum(feL3n4SHA256Sum string) error
	SVCGet(feL3n4 types.L3n4AddrID) ([]types.L3n4Addr, error)
	SVCGetBySHA256Sum(feL3n4SHA256Sum string) ([]types.L3n4Addr, error)
